...
[TIP]
====
A unidade financeiro do Bitcoin é o bit($), e a menor unidade do Bitcoin é o Satoshi.
BTC, 000 001 bit equivale a 100 satoshis que são representadas pela 7 e 8 casa decimal depois da vírgula.
====
